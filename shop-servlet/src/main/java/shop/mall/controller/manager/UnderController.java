...
/**
 * Servlet implementation class UnderController
 */
@WebServlet("/manager/under")
public class UnderController extends HttpServlet {
...
//				System.out.println(f1.length());   // 그 파일의 크기 
		...
		Integer result = service.setUnderBannerImage(imageList);
